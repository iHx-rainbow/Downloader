	...
	*/
	...
	public void addBars(List<DownloadInfo> infos) {
        ...
        for (DownloadInfo info : infos){
            ...
            bars[info.getIndex()].setBounds(230, yOffset + info.getIndex() * 16 , 200, 15);
            exist=exist+1;
    ...
    public void updateBar(int index, int len, int fileLength) {
        ...
        total=0;
        for (int i=0;i<exist;i++){
	        total=bars[i].getValue()+total;
		}
        updateProcess(fileLength);
        //total = total+len;
		/*

	

        //a[index]=bars[index].getValue();
        //total=a[0]+a[1]+a[2];
    ...
    public void updateProcess(int fileLength) {
        ...
        jLabel3.setText(total+"/"+fileLength);
    	this.repaint();
    }
    */
